...
import { isTemplateStringsArray } from './utils.js';

function getTemplateStringsArray(strings: TemplateStringsArray, ...values: unknown[]) {
  return strings;
}

describe('isTemplateStringsArray', () => {
  it('should return true for a TemplateStringsArray', () => {
    let templateStringsArray = getTemplateStringsArray`hi ${'mom'}, hi ${'dad'}`;
